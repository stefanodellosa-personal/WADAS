...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionSave_configuration_to_file_menu = QAction(MainWindow)
        self.actionSave_configuration_to_file_menu.setObjectName(u"actionSave_configuration_to_file_menu")
        self.actionSave_configuration_to_file_menu.setIcon(icon7)
        ...
        self.menuFile.addAction(self.actionSave_configuration_to_file_menu)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionSave_configuration_to_file_menu.setText(QCoreApplication.translate("MainWindow", u"Save configuration to file", None))
