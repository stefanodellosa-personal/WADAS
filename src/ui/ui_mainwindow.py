...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionactionConfigure_camera_to_actuator_associations = QAction(MainWindow)
        self.actionactionConfigure_camera_to_actuator_associations.setObjectName(u"actionactionConfigure_camera_to_actuator_associations")
        icon12 = QIcon(QIcon.fromTheme(u"insert-link"))
        self.actionactionConfigure_camera_to_actuator_associations.setIcon(icon12)
        self.actionactionConfigure_camera_to_actuator_associations.setMenuRole(QAction.MenuRole.NoRole)
        ...
        self.toolBar.addAction(self.actionactionConfigure_camera_to_actuator_associations)
...
#endif // QT_CONFIG(tooltip)
        self.actionactionConfigure_camera_to_actuator_associations.setText(QCoreApplication.translate("MainWindow", u"actionConfigure_camera_to_actuator_associations", None))
#if QT_CONFIG(tooltip)
        self.actionactionConfigure_camera_to_actuator_associations.setToolTip(QCoreApplication.translate("MainWindow", u"Configure camera to actuator association(s)", None))
#endif // QT_CONFIG(tooltip)
