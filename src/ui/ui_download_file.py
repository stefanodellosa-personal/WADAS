...
class Ui_DialogDownloadFile(object):
    def setupUi(self, DialogDownloadFile):
        if not DialogDownloadFile.objectName():
            DialogDownloadFile.setObjectName(u"DialogDownloadFile")
    ...
    def retranslateUi(self, DialogDownloadFile):
        DialogDownloadFile.setWindowTitle(QCoreApplication.translate("DialogDownloadFile", u"Download file", None))
        self.label.setText(QCoreApplication.translate("DialogDownloadFile", u"Click Download button to start.", None))
        self.pushButton_download.setText(QCoreApplication.translate("DialogDownloadFile", u"Download", None))
        self.pushButton_cancel.setText(QCoreApplication.translate("DialogDownloadFile", u"Cancel", None))
    # retranslateUi
