...
class Ui_ConfigureDBDialog(object):
    def setupUi(self, ConfigureDBDialog):
        ...
        self.gridLayout_mysql.addWidget(self.lineEdit_db_host, 5, 1, 1, 1)
        ...
        self.gridLayout_mysql.addWidget(self.pushButton_create_db, 3, 1, 1, 1)
        ...
        self.gridLayout_mysql.addWidget(self.lineEdit_db_username, 6, 1, 1, 1)
        ...
        self.gridLayout_mysql.addWidget(self.plainTextEdit_db_test, 12, 0, 1, 2)
        ...
        self.gridLayout_mysql.addWidget(self.line, 10, 0, 1, 2)
        ...
        self.gridLayout_mysql.addWidget(self.pushButton_test_db, 11, 0, 1, 2)
        ...
        self.gridLayout_mysql.addWidget(self.lineEdit_db_password, 7, 1, 1, 1)
        ...
        self.gridLayout_mysql.addWidget(self.radioButton_MySQL, 2, 1, 1, 1)
