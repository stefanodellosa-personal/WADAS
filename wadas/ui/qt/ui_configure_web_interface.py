...
class Ui_DialogConfigureWebInterface(object):
    def setupUi(self, DialogConfigureWebInterface):
        ...
        self.label_errorMessage.setGeometry(QRect(20, 390, 551, 16))
        self.horizontalLayoutWidget = QWidget(DialogConfigureWebInterface)
        self.horizontalLayoutWidget.setObjectName(u"horizontalLayoutWidget")
        self.horizontalLayoutWidget.setGeometry(QRect(10, 10, 561, 31))
        ...
        self.horizontalLayoutWidget_2.setGeometry(QRect(10, 360, 561, 31))
