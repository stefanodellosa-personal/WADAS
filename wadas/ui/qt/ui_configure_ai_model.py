...
class Ui_DialogConfigureAi(object):
    def setupUi(self, DialogConfigureAi):
        ...
        self.gridLayoutWidget.setGeometry(QRect(10, 10, 381, 126))
        ...
        self.gridLayout.addWidget(self.label_errorMEssage, 4, 1, 1, 1)
    ...
    def retranslateUi(self, DialogConfigureAi):
        ...
        self.label_2.setText(QCoreApplication.translate("DialogConfigureAi", u"Ai device", None))
    # retranslateUi
